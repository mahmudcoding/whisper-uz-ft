...
- 264.9430h;
- USC + Common Voice Uzbek + FLEURS + FeruzaSpeech;
- 237.3059h train / 13.2166h validation / 14.4205h test;
- zero known path/hash/speaker leakage;
- FeruzaSpeech contributes 57.8279h from 12,854 clips and 127 speakers.
- FeruzaSpeech is restricted to academic research/internal use under gated terms;
  do not redistribute it or assume commercial rights.
