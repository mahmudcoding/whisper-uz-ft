        ...
        rows.append(
            {
                ...
                "encoder_block_a_lr": payload.get("encoder_block_a_lr"),
                "encoder_block_b_lr": payload.get("encoder_block_b_lr"),
                "encoder_block_c_lr": payload.get("encoder_block_c_lr"),
                "encoder_block_d_lr": payload.get("encoder_block_d_lr"),
